...
def generate_pdf(df, username, full_name, gender, age):
    ...
    pdf.set_font("Arial", size=12)
    if avg_glucose > 140:
        pdf.set_text_color(255, 0, 0)  # Red color for warnings
        pdf.cell(200, 10, txt="⚠️ High glucose levels detected. Consider reducing sugar intake and consulting a doctor.", ln=True)
    if avg_bmi > 25:
        pdf.set_text_color(255, 0, 0)
        pdf.cell(200, 10, txt="⚠️ High BMI detected. Maintain a balanced diet and exercise regularly.", ln=True)
    if positive_predictions > 0:
        pdf.set_text_color(255, 0, 0)
        pdf.cell(200, 10, txt="⚠️ Positive diabetes predictions detected. Schedule a medical checkup for further evaluation.", ln=True)
